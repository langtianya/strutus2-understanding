...
/**
 * 拦截器是一个无状态的类，如下的拦截模式，如在javax.servlet.filter和AOP的语言中发现的
 ...
 * @author tmjee
 * @version $Date: 2009-12-27 19:18:29 +0100 (Sun, 27 Dec 2009) $ $Id: Interceptor.java 894090 2009-12-27 18:18:29Z martinc $
 */
public interface Interceptor extends Serializable {
    ...
    /**
     ...
     允许拦截器做一些由actioninvocation的处理请求的rest或短路处理之的前和/或之后的处理请求，并且只是返回一个字符串返回代码。 
