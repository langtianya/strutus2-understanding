 ...
 */
public class PackageConfig extends Located implements Comparable<Object>, Serializable, InterceptorLocator {
    ...
    /**
     * 返回所有在当前包可用的ActionConfigs的Map。ActionConfigs定义在祖先包的，将包含在该Map<br/>
