/*
 * $Id: DefaultActionProxy.java 1292705 2012-02-23 08:40:53Z lukaszlenart $
 *
 ...
 * @author tmjee
 * @version $Date: 2012-02-23 09:40:53 +0100 (Thu, 23 Feb 2012) $ $Id: DefaultActionProxy.java 1292705 2012-02-23 08:40:53Z lukaszlenart $
 * @since 2005-8-6
 */
public class DefaultActionProxy implements ActionProxy, Serializable {
     ...
     * @see com.opensymphony.xwork2.ActionProxy#getAction()
     */
    ...
    /**
     * @see com.opensymphony.xwork2.ActionProxy#execute()
     */
    public String execute() throws Exception {
//    1、	执行invocation之前取出先前的ActionContext 
        ActionContext nestedContext = ActionContext.getContext();
//    2、    然后放入ActionInvocation相关的ActionContext
...
//			如果清理上下文，就设置回执行ActionInvocation之前的ActionContext
			if (cleanupContext) {
