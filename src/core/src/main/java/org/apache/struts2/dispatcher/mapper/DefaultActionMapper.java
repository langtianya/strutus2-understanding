/*
 * $Id: DefaultActionMapper.java 1459650 2013-03-22 07:22:45Z lukaszlenart $
 *
...
/**
 * 
 * 默认action映射实现，使用标准的.[ext]（扩展名通常“action”）模式。扩展名是看着Struts配置的key，struts.action.extension。
