/*
 * $Id: FilterDispatcher.java 1375926 2012-08-22 07:58:38Z lukaszlenart $
 *
 ...
 * the subclass.
 *
 * @version $Date: 2012-08-22 09:58:38 +0200 (Wed, 22 Aug 2012) $ $Id: FilterDispatcher.java 1375926 2012-08-22 07:58:38Z lukaszlenart $
...
//            	http://www.cnblogs.com/ycxyyzw/archive/2012/07/31/2616951.html
				...
				// 当没有action对应请求时，将查找静态资源
				String resourcePath = RequestUtils.getServletPath(request);
				
//				resourcePath为空时，使用
                if ("".equals(resourcePath) && null != request.getPathInfo()) {
//                返回与客户端发送此请求时所发送的地址相关联的任何额外的路径信息。
         ...
         //   ActionMapper取得了ActionMapping后，在Dispatcher的serviceAction方法里创建ActionProxy
