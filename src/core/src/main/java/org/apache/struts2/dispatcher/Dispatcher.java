/*
 * $Id: Dispatcher.java 1447453 2013-02-18 19:53:42Z lukaszlenart $
 *
...
/**
 * 实际的调度程序将其大部分任务委托给它的一个实用类，每个dispatcher的每个实例都持有该dispatcher的一个实例，
 * 用于所有请求的共享
 * <p>
...
public class Dispatcher {
    ...
    /**
     * 这个是读取struts-default.xml和Struts.xml的方法
     */
    ...
    /**
     * ActionMapper取得了ActionMapping后，在Dispatcher的serviceAction方法里创建ActionProxy<br/>
     * 为mapping 加载Action类，并调用相应的Action方法，或者直接到达Result
     * <p>
    ...
    public void serviceAction(HttpServletRequest request, HttpServletResponse response, ServletContext context,
        ...
        try {
			...
			// 从配置管理获取配置
			Configuration config = configurationManager.getConfiguration();
//            从容器获取ActionProxyFactory类，并用其创建代理
